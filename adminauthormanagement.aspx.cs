...
namespace eLIBRARY
{
    public partial class adminauthormanagement : System.Web.UI.Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Write("<script>alert('AUTHOR WITH SAME ID ALLREADY EXISTS PLEASE TRY WITH DIFFERENT ID');</script>");
            }
            else
            {
                addNewAuthor();
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Write("<script>alert('AUTHOR IS NOT PRESENT WITH THIS ID');</script>");
